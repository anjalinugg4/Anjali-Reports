...
|7/20 | started reading new research paper that used igibson as a citation, forked and cloned Oldenborg training from arcslab github, made changes to the inference.py file, created new artifact with 4K images that have no randomized changes in texture
|7/21 | 
